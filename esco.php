...
<body>
    ...
    <label for="genero">Escolaridade </label>
    <select  name="genero">
      <option value="masculino">Ensino Fundamental</option>
      <option value="medio">Ensino Médio</option>
      <option value="superior">Ensino Superior</option>
      <option value="espe">Pós Graduação(Especialização)</option>
      <option value="mestrado">Pós Graduação(Mestrado)</option>
      <option value="dout">Pós Graduação(Doutorado)</option>
    </select>
    <br>
    <br>
